package syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition;
...
import syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.RegistereintragKategorieElement;
import syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.StatusDefiningCode;
...
public class HerzfrequenzCompositionContainment extends Containment {
  ...
  public ListSelectAqlField<RegistereintragKategorieElement> KATEGORIE = new ListAqlFieldImp<RegistereintragKategorieElement>(HerzfrequenzComposition.class, "/context/other_context[at0001]/items[at0005]", "kategorie", RegistereintragKategorieElement.class, this);
  ...
  public SelectAqlField<PulsfrequenzHerzfrequenzObservation> PULSFREQUENZ_HERZFREQUENZ = new AqlFieldImp<PulsfrequenzHerzfrequenzObservation>(HerzfrequenzComposition.class, "/content[openEHR-EHR-OBSERVATION.pulse.v2]", "pulsfrequenzHerzfrequenz", PulsfrequenzHerzfrequenzObservation.class, this);
