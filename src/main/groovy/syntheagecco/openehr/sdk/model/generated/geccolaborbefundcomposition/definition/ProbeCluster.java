...
@Generated(
    ...
    date = "2021-09-01T01:48:06.608296200+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ProbeCluster implements LocatableEntity {
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Probenart
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Probenart/null_flavour
   */
  @Path("/items[at0029]/null_flavour|defining_code")
  private NullFlavour probenartNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Laborprobenidentifikator
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Laborprobenidentifikator/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour laborprobenidentifikatorNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Externer Identifikator
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Externer Identifikator/null_flavour
   */
  @Path("/items[at0088]/null_flavour|defining_code")
  private NullFlavour externerIdentifikatorNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt des Probeneingangs
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Zeitpunkt des Probeneingangs/null_flavour
   */
  @Path("/items[at0034]/null_flavour|defining_code")
  private NullFlavour zeitpunktDesProbeneingangsNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Probenentahmebedingung
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Physische Eigenschaften
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Probenentnahmemethode
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Probenentnahmemethode/null_flavour
   */
  @Path("/items[at0007]/null_flavour|defining_code")
  private NullFlavour probenentnahmemethodeNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Körperstelle
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Körperstelle/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Anatomische Probenentnahmestelle
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme/lower_included
   */
  @Path("/items[at0015]/value/lower_included")
  private Boolean lowerIncluded;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme/upper_included
   */
  @Path("/items[at0015]/value/upper_included")
  private Boolean upperIncluded;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme/upper
   */
  @Path("/items[at0015]/value/upper")
  private DvOrdered upper;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme/lower
   */
  @Path("/items[at0015]/value/lower")
  private DvOrdered lower;

  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Zeitpunkt der Probenentnahme/null_flavour
   */
  @Path("/items[at0015]/null_flavour|defining_code")
  private NullFlavour zeitpunktDerProbenentnahmeNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Identifikator des Probennehmers
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Identifikator des Probennehmers/null_flavour
   */
  @Path("/items[at0070]/null_flavour|defining_code")
  private NullFlavour identifikatorDesProbennehmersNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Angaben zum Probennehmer
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Zusätzliche Angaben zur Probennahme
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Behälter Details
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Angaben zur Verarbeitung
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Angaben zum Transport
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Digitale Darstellung
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Identifikator der übergeordneten Probe
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Eignung zum Testen/null_flavour
   */
  @Path("/items[at0041]/null_flavour|defining_code")
  private NullFlavour eignungZumTestenNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Kommentar
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Probe/Kommentar/null_flavour
   */
  @Path("/items[at0045]/null_flavour|defining_code")
  private NullFlavour kommentarNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Probe/Eignung zum Testen
