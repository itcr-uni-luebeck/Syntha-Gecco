...
public class BefundObservationContainment extends Containment {
  ...
  public SelectAqlField<AnforderungDefiningCode> ANFORDERUNG_DEFINING_CODE = new AqlFieldImp<AnforderungDefiningCode>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0106]/value|defining_code", "anforderungDefiningCode", AnforderungDefiningCode.class, this);

  public SelectAqlField<NullFlavour> ANFORDERUNG_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0106]/null_flavour|defining_code", "anforderungNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<Cluster> EINSENDER = new AqlFieldImp<Cluster>(BefundObservation.class, "/protocol[at0004]/items[at0094]/items[at0090]", "einsender", Cluster.class, this);
