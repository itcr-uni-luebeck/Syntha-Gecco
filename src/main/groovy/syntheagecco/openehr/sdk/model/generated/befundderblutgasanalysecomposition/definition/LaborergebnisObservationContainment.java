...
public class LaborergebnisObservationContainment extends Containment {
  ...
  public SelectAqlField<NullFlavour> LABORTEST_BEZEICHNUNG_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0005]/null_flavour|defining_code", "labortestBezeichnungNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<SauerstoffsaettigungCluster> SAUERSTOFFSAETTIGUNG = new AqlFieldImp<SauerstoffsaettigungCluster>(LaborergebnisObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[openEHR-EHR-CLUSTER.laboratory_test_analyte.v1]", "sauerstoffsaettigung", SauerstoffsaettigungCluster.class, this);
