package syntheagecco.openehr.sdk.model.generated.blutdruckcomposition;
...
import syntheagecco.openehr.sdk.model.generated.blutdruckcomposition.definition.StatusDefiningCode;
...
public class BlutdruckCompositionContainment extends Containment {
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(BlutdruckComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(BlutdruckComposition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);
