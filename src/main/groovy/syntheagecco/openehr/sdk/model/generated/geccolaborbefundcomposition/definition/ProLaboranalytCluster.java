...
@Generated(
    ...
    date = "2021-09-01T01:48:06.709295+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class ProLaboranalytCluster implements LocatableEntity {
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Bezeichnung des Analyts
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Bezeichnung des Analyts/null_flavour
   */
  @Path("/items[at0024]/null_flavour|defining_code")
  private NullFlavour bezeichnungDesAnalytsNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Messwert/null_flavour
   */
  @Path("/items[at0001 and name/value='Messwert']/null_flavour|defining_code")
  private NullFlavour messwertNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Analyseergebnis-Detail
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Interpretation
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Interpretation/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Testmethode/null_flavour
   */
  @Path("/items[at0028]/null_flavour|defining_code")
  private NullFlavour testmethodeNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Zeitpunkt der Validierung
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Zeitpunkt der Validierung/null_flavour
   */
  @Path("/items[at0025]/null_flavour|defining_code")
  private NullFlavour zeitpunktDerValidierungNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Ergebnis-Status/null_flavour
   */
  @Path("/items[at0005]/null_flavour|defining_code")
  private NullFlavour ergebnisStatusNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Zeitpunkt Ergebnis-Status
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Zeitpunkt Ergebnis-Status/null_flavour
   */
  @Path("/items[at0006]/null_flavour|defining_code")
  private NullFlavour zeitpunktErgebnisStatusNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Event Series/Jedes Ereignis/Tree/Pro Laboranalyt/Probe ID/null_flavour
   */
  @Path("/items[at0026 and name/value='Probe ID']/null_flavour|defining_code")
  private NullFlavour probeIdNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Kommentar
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Testmethode
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Probe ID
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Ergebnis-Status
  ...
  /**
   * Path: Registereintrag/Laborergebnis/Jedes Ereignis/Pro Laboranalyt/Messwert
