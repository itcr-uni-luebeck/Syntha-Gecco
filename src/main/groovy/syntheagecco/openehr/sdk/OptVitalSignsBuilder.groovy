...
import syntheagecco.openehr.sdk.model.generated.atemfrequenzcomposition.AtemfrequenzComposition
import syntheagecco.openehr.sdk.model.generated.atemfrequenzcomposition.definition.AtemfrequenzObservation
import syntheagecco.openehr.sdk.model.generated.atemfrequenzcomposition.definition.RegistereintragKategorieElement
import syntheagecco.openehr.sdk.model.generated.atemfrequenzcomposition.definition.StatusDefiningCode
import syntheagecco.openehr.sdk.model.generated.beatmungswertecomposition.BeatmungswerteComposition
import syntheagecco.openehr.sdk.model.generated.beatmungswertecomposition.definition.BeobachtungenAmBeatmungsgeraetObservation
import syntheagecco.openehr.sdk.model.generated.beatmungswertecomposition.definition.EingeatmeterSauerstoffCluster
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.BefundDerBlutgasanalyseComposition
...
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.KohlendioxidpartialdruckCluster
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.KohlendioxidpartialdruckErgebnisStatusElement
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.LaborergebnisObservation
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.LabortestBezeichnungDefiningCode
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.PhWertCluster
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.SauerstoffpartialdruckCluster
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.SauerstoffpartialdruckErgebnisStatusElement
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.SauerstoffsaettigungCluster
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.UntersuchterAnalytDefiningCode
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.UntersuchterAnalytDefiningCode2
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.UntersuchterAnalytDefiningCode3
import syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.UntersuchterAnalytDefiningCode4
import syntheagecco.openehr.sdk.model.generated.blutdruckcomposition.BlutdruckComposition
import syntheagecco.openehr.sdk.model.generated.blutdruckcomposition.definition.BlutdruckKategorieElement
import syntheagecco.openehr.sdk.model.generated.blutdruckcomposition.definition.BlutdruckObservation
import syntheagecco.openehr.sdk.model.generated.geccomedikationcomposition.GECCOMedikationComposition
import syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.HerzfrequenzComposition
import syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.PulsfrequenzHerzfrequenzObservation
import syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.KoerpertemperaturComposition
import syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.definition.KategorieDefiningCode
import syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.definition.KoerpertemperaturObservation
import syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.PulsoxymetrieComposition
import syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.definition.PulsoxymetrieObservation
...
class OptVitalSignsBuilder extends BaseOTBuilder{
    ...
    private List<BeatmungswerteComposition> buildFiO2Resources(List<SObservation> observations, CompositionProvider provider){
        ...
        observations.each { observation ->
            ...
            fiO2.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.beatmungswertecomposition.definition.StatusDefiningCode.FINAL)
    ...
    private List<BlutdruckComposition> buildBloodPressureResources(List<SMultiObservation> observations, CompositionProvider provider){
        ...
        observations.each { observation ->
            ...
            bp.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.blutdruckcomposition.definition.StatusDefiningCode.FINAL)
    ...
    private List<HerzfrequenzComposition> buildHeartRateResources(List<SObservation> observations, CompositionProvider provider){
        ...
        observations.each {observation ->
            ...
            hr.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.StatusDefiningCode.FINAL)

            hr.setKategorie([new syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.RegistereintragKategorieElement().with(true) {
                value = "http://terminology.hl7.org/CodeSystem/observation-category::vital-signs::Vital Signs"
            }] as List<syntheagecco.openehr.sdk.model.generated.herzfrequenzcomposition.definition.RegistereintragKategorieElement>)
    ...
    private List<KoerpertemperaturComposition> buildBodyTemperatureResources(List<SObservation> observations, CompositionProvider provider){
        ...
        observations.each {observation ->
            ...
            bt.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.definition.StatusDefiningCode.FINAL)

            bt.setKategorie([new syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.definition.RegistereintragKategorieElement().with(true) {
                value = KategorieDefiningCode.VITAL_SIGNS
            }] as List<syntheagecco.openehr.sdk.model.generated.koerpertemperaturcomposition.definition.RegistereintragKategorieElement>)
    ...
    private List<PulsoxymetrieComposition> buildOxySaturationResources(List<SObservation> observations, CompositionProvider provider){
        ...
        observations.each {observation ->
            ...
            os.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.definition.StatusDefiningCode.FINAL)

            os.setKategorie([new syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.definition.RegistereintragKategorieElement().with(true) {
                value = "http://terminology.hl7.org/CodeSystem/observation-category::vital-signs::Vital Signs"
            }] as List<syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.definition.RegistereintragKategorieElement>)
    ...
    private List<BefundDerBlutgasanalyseComposition> buildBloodGasPanelResources(List<SDiagnosticReport> diagnosticReports, HashMap<SDiagnosticReport, List<SObservation>> reportMap, CompositionProvider provider){
        ...
        diagnosticReports.each {diagnosticReport ->
            ...
            dp.setStatusDefiningCode(syntheagecco.openehr.sdk.model.generated.befundderblutgasanalysecomposition.definition.StatusDefiningCode.FINAL)
