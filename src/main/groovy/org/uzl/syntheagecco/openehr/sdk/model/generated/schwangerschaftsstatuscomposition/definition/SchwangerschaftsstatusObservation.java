package org.uzl.syntheagecco.openehr.sdk.model.generated.schwangerschaftsstatuscomposition.definition;
...
@Generated(
    ...
    date = "2021-09-01T01:49:04.995433+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class SchwangerschaftsstatusObservation implements EntryEntity {
  /**
   * Path: Registereintrag/Schwangerschaftsstatus/Beliebiges Ereignis/Status
  ...
  /**
   * Path: Registereintrag/Schwangerschaftsstatus/History/Beliebiges Ereignis/Tree/Status/null_flavour
   */
  @Path("/data[at0001]/events[at0002]/data[at0003]/items[at0011]/null_flavour|defining_code")
  private NullFlavour statusNullFlavourDefiningCode;

  /**
   * Path: Registereintrag/Schwangerschaftsstatus/Beliebiges Ereignis/time
   */
  @Path("/data[at0001]/events[at0002]/time|value")
  private TemporalAccessor timeValue;

  /**
   * Path: Registereintrag/Schwangerschaftsstatus/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Registereintrag/Schwangerschaftsstatus/Erweiterungen
  ...
  /**
   * Path: Registereintrag/Schwangerschaftsstatus/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Registereintrag/Schwangerschaftsstatus/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Registereintrag/Schwangerschaftsstatus/feeder_audit
   */
  @Path("/feeder_audit")
