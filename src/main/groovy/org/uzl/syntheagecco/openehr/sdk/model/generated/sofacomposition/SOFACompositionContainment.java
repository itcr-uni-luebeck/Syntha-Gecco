package org.uzl.syntheagecco.openehr.sdk.model.generated.sofacomposition;
...
import org.uzl.syntheagecco.openehr.sdk.model.generated.sofacomposition.definition.RegistereintragKategorieElement;
import org.uzl.syntheagecco.openehr.sdk.model.generated.sofacomposition.definition.SofaScoreObservation;
import org.uzl.syntheagecco.openehr.sdk.model.generated.sofacomposition.definition.StatusDefiningCode;
...
public class SOFACompositionContainment extends Containment {
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(SOFAComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);
  ...
  public SelectAqlField<StatusDefiningCode> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode>(SOFAComposition.class, "/context/other_context[at0001]/items[at0004]/value|defining_code", "statusDefiningCode", StatusDefiningCode.class, this);

  public SelectAqlField<NullFlavour> STATUS_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SOFAComposition.class, "/context/other_context[at0001]/items[at0004]/null_flavour|defining_code", "statusNullFlavourDefiningCode", NullFlavour.class, this);

  public ListSelectAqlField<RegistereintragKategorieElement> KATEGORIE = new ListAqlFieldImp<RegistereintragKategorieElement>(SOFAComposition.class, "/context/other_context[at0001]/items[at0005]", "kategorie", RegistereintragKategorieElement.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(SOFAComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(SOFAComposition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);
