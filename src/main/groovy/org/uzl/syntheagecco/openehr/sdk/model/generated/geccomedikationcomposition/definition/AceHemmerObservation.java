...
@Generated(
    ...
    date = "2021-09-01T01:48:10.132033700+02:00",
...
public class AceHemmerObservation implements EntryEntity {
  ...
  /**
   * Path: Medikation/ACE-Hemmer/History/Beliebiges Ereignis/Tree/Status/null_flavour
   */
  ...
  /**
   * Path: Medikation/ACE-Hemmer/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Medikation/ACE-Hemmer/Status
  ...
  /**
   * Path: Medikation/ACE-Hemmer/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Medikation/ACE-Hemmer/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Medikation/ACE-Hemmer/feeder_audit
   */
  @Path("/feeder_audit")
