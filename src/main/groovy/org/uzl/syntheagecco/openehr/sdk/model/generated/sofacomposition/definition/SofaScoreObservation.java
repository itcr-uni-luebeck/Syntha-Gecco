package org.uzl.syntheagecco.openehr.sdk.model.generated.sofacomposition.definition;
...
@Generated(
    ...
    date = "2021-09-01T01:49:07.970499800+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class SofaScoreObservation implements EntryEntity {
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Respiration
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Respiration/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Kardiovaskuläres System
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Kardiovaskuläres System/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Zentrales Nervensystem
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Zentrales Nervensystem/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Nierenfunktion
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Nierenfunktion/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Leberfunktion
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Leberfunktion/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Blutgerinnung
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Blutgerinnung/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/Gesamtergebnis
  ...
  /**
   * Path: Registereintrag/SOFA score/Event Series/Beliebiges Ereignis zu einem Zeitpunkt/Tree/Gesamtergebnis/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/SOFA score/Beliebiges Ereignis zu einem Zeitpunkt/time
   */
  @Path("/data[at0001]/events[at0002]/time|value")
  private TemporalAccessor timeValue;

  /**
   * Path: Registereintrag/SOFA score/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Registereintrag/SOFA score/Erweiterung
  ...
  /**
   * Path: Registereintrag/SOFA score/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Registereintrag/SOFA score/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Registereintrag/SOFA score/feeder_audit
   */
  @Path("/feeder_audit")
