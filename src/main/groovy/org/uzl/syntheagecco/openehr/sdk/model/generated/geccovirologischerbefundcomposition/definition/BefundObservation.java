...
@Generated(
    ...
    date = "2021-09-01T01:48:29.103662600+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class BefundObservation implements EntryEntity {
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Labortest-Bezeichnung
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Labortest-Bezeichnung/null_flavour
   */
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Probendetail
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Labortest-Panel
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Strukturierte Testdiagnostik
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Multimedia-Darstellung
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/Strukturierte Erfassung der Störfaktoren
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Jedes Ereignis/time
   */
  @Path("/data[at0001]/events[at0002]/time|value")
  private TemporalAccessor timeValue;

  /**
   * Path: GECCO_Virologischer Befund/Befund/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: GECCO_Virologischer Befund/Befund/Labor, welches den Untersuchungsauftrag annimmt
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Test Details
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/Erweiterung
  ...
  /**
   * Path: GECCO_Virologischer Befund/Befund/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: GECCO_Virologischer Befund/Befund/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: GECCO_Virologischer Befund/Befund/feeder_audit
   */
  @Path("/feeder_audit")
