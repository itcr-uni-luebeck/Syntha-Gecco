package org.uzl.syntheagecco.openehr.sdk.model.generated.pulsoxymetriecomposition.definition;
...
@Generated(
    ...
    date = "2021-09-01T01:48:53.342841400+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class PulsoxymetrieObservation implements EntryEntity {
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/SpO₂
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Event Series/Beliebiges Ereignis/Baum/SpO₂/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/Wellenform
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/Multimedia-Bild
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/Anstrengung
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/Eingeatmeter Sauerstoff
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Beliebiges Ereignis/time
   */
  @Path("/data[at0001]/events[at0002]/time|value")
  private TemporalAccessor timeValue;

  /**
   * Path: Registereintrag/Pulsoxymetrie/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Registereintrag/Pulsoxymetrie/Oxymetrie Gerät
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/Erweiterung
  ...
  /**
   * Path: Registereintrag/Pulsoxymetrie/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Registereintrag/Pulsoxymetrie/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Registereintrag/Pulsoxymetrie/feeder_audit
   */
  @Path("/feeder_audit")
