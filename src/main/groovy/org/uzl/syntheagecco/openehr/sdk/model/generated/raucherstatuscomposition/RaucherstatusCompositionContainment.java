package org.uzl.syntheagecco.openehr.sdk.model.generated.raucherstatuscomposition;
...
import org.uzl.syntheagecco.openehr.sdk.model.generated.raucherstatuscomposition.definition.RaucherstatusEvaluation;
import org.uzl.syntheagecco.openehr.sdk.model.generated.raucherstatuscomposition.definition.RegistereintragKategorieElement;
import org.uzl.syntheagecco.openehr.sdk.model.generated.raucherstatuscomposition.definition.StatusDefiningCode;
...
public class RaucherstatusCompositionContainment extends Containment {
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(RaucherstatusComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);
  ...
  public SelectAqlField<StatusDefiningCode> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode>(RaucherstatusComposition.class, "/context/other_context[at0001]/items[at0004]/value|defining_code", "statusDefiningCode", StatusDefiningCode.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(RaucherstatusComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

  public SelectAqlField<RaucherstatusEvaluation> RAUCHERSTATUS = new AqlFieldImp<RaucherstatusEvaluation>(RaucherstatusComposition.class, "/content[openEHR-EHR-EVALUATION.tobacco_smoking_summary.v1]", "raucherstatus", RaucherstatusEvaluation.class, this);
