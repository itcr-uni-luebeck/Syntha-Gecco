package org.uzl.syntheagecco.openehr.sdk.model.generated.patientauficucomposition;
...
import org.uzl.syntheagecco.openehr.sdk.model.generated.patientauficucomposition.definition.PatientAufDerIntensivstationObservation;
import org.uzl.syntheagecco.openehr.sdk.model.generated.patientauficucomposition.definition.StatusDefiningCode;
...
public class PatientAufICUCompositionContainment extends Containment {
  ...
  public SelectAqlField<Category> CATEGORY_DEFINING_CODE = new AqlFieldImp<Category>(PatientAufICUComposition.class, "/category|defining_code", "categoryDefiningCode", Category.class, this);
  ...
  public SelectAqlField<StatusDefiningCode> STATUS_DEFINING_CODE = new AqlFieldImp<StatusDefiningCode>(PatientAufICUComposition.class, "/context/other_context[at0001]/items[at0004]/value|defining_code", "statusDefiningCode", StatusDefiningCode.class, this);

  public SelectAqlField<NullFlavour> STATUS_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(PatientAufICUComposition.class, "/context/other_context[at0001]/items[at0004]/null_flavour|defining_code", "statusNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<Setting> SETTING_DEFINING_CODE = new AqlFieldImp<Setting>(PatientAufICUComposition.class, "/context/setting|defining_code", "settingDefiningCode", Setting.class, this);

  public SelectAqlField<PatientAufDerIntensivstationObservation> PATIENT_AUF_DER_INTENSIVSTATION = new AqlFieldImp<PatientAufDerIntensivstationObservation>(PatientAufICUComposition.class, "/content[openEHR-EHR-OBSERVATION.management_screening.v0]", "patientAufDerIntensivstation", PatientAufDerIntensivstationObservation.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(PatientAufICUComposition.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);
