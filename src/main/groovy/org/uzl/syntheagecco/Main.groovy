...
import org.uzl.syntheagecco.extraction.JSONExtractor
import org.uzl.syntheagecco.extraction.model.CaseInformation
import org.uzl.syntheagecco.fhir.FhirCaseBuilder
import org.uzl.syntheagecco.fhir.model.FhirGeccoCase
import org.uzl.syntheagecco.fhir.validation.FHIRInstanceValidator
import org.uzl.syntheagecco.fhir.validation.FhirFileValidator
import org.uzl.syntheagecco.openehr.sdk.CompositionProvider
import org.uzl.syntheagecco.openehr.sdk.CompositionProviderConfig
import org.uzl.syntheagecco.openehr.sdk.OtpCaseBuilder
import org.uzl.syntheagecco.openehr.sdk.client.EhrBaseClient
import org.uzl.syntheagecco.openehr.sdk.client.TemplateProviderImp
...
class Main {
    ...
    @SuppressWarnings('GroovyConstantNamingConvention')
    private static String SYNTHEA_EXPORTER_DIRECTORY = Paths.get("src", "main", "resources", "output").toString()

    static class ArgParser {

        private class Defaults {
            static String POPULATION = "100"
            static String SEED = System.currentTimeMillis().toString()
            static String NO_VALIDATION = SyntheaGeccoConfig.ValidationStrategy.NO_VALIDATION.valueOf()
            class OpenEhr {
                class Composer {
                    @SuppressWarnings('GroovyConstantNamingConvention')
                    static String REF_ID_VALUE = "synthea-gecco"
                    @SuppressWarnings('GroovyConstantNamingConvention')
                    static String REF_ID_SCHEME = "synthea-gecco"
                    @SuppressWarnings('GroovyConstantNamingConvention')
                    static String REF_NAMESPACE = "synthea"
                    static String NAME = "synthea-gecco"
                }
            }
        }
        ...
        static OptionAccessor parseArgs(String[] args) {
            ...
            cli.with {
                ...
                f longOpt: 'fhir', "Enables generation of FHIR related data. Enabled by default"
